...
namespace ServiceHubClass
{
    public class Produto
    {
        ...
        public Produto(string? codBarras, string? descricao, double valorUnit,
            string? unidadeVenda, Categoria? categoria,
            double estoqueMinimo, double classeDesconto)
        {
            CodBarras = codBarras;
            Descricao = descricao;
            ValorUnit = valorUnit;
        ...
        public Produto(int id, string? codBarras, string? descricao,
            double valorUnit, string? unidadeVenda,
            Categoria? categoria, double estoqueMinimo,
        ...
        public Produto(int id, string? codBarras, string? descricao,
            double valorUnit, string? unidadeVenda,
            Categoria? categoria, double estoqueMinimo,
            double classeDesconto, byte[] imagem,
            DateTime dataCad, bool descontinuado)
        {
            Id = id;
            CodBarras = codBarras;
            Descricao = descricao;
        ...
        // CORRIGIDO: removido parâmetro int id
